...
const RequestsForm = (props) => {
    ...
    return (
        <>
            <div >
                <form autoComplete="off" className="offset-md-0.5  align-items-center" onSubmit={handleFormSubmit}>
                    <div className="col-auto">
                        <div className="form-group ">
                            <input type="hidden" name="user" value={props.user} />
                            <label htmlFor="inputCity">Amount</label>
                            <input type="number" name="amount" onChange={handleInputChange} value={values.amount} className="form-control" id="inputCity" />
                        </div>
                        <div className="form-group col-auto">
                            <label htmlFor="inputCurrency">Currency</label>
                            <select id="inputCurrency" name="currency" className="form-control" onChange={handleInputChange} value={values.currency}>
           ...
           <option value="amount">amount</option> */}
                        ...
                        <div className="form-group col-md-4">
                            ...
                            <select id="inputAction" name="action" className="form-control" onChange={handleInputChange} value={values.action}>
                                {/* <option defaultValue>Choose...</option>
           <option value="amount">amount</option> */}
                                <option value="..." defaultValue >Choose Action</option>
                            ...
                            {props.user == "admin@admin.com" && props.currentId &&
                                <>
                                    ...
                                    <select id="inputAction" name="status" className="form-control" onChange={handleInputChange} value={values.status}>
                                        {/* <option defaultValue>Choose...</option>
           <option value="amount">amount</option> */}
                        ...
                        <button type="submit" className="btn btn-primary col-md-1 mb-3">Submit</button>
                    </div>
